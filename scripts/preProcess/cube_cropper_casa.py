...
'''
Cut datacubes into smaller pieces and revise the header keyword 'RESTFRQ'
...
for i in range(len(cubes)):
    ...
    imhead(imagename='casaCUT.im',
           mode='put', hdkey='restfrq', hdvalue=str(f0)) # 資料型態竟然要是字串，不客氣，幫轉了
    print(f"Finish cropping {mole} and the header keyWord 'RESTFRQ' now is {f0} Hz.") 
