...
# Use the result of 'fit_fitMANYpix_(ugly or parallel).py'
# ugly give partial map while parallel give wholemap.
'''
Please first scp back fitting results from the server, 
- map_chi2Min_{nline}line_{whichone}.npy
- map_bestPhyCondi_{nline}line_{whichone}.npy

Or get entire folder back by this command
$scp -r aqing@140.xxx.xx.xx:~/Documents/line_modeling_Circinus/products/fittingResult_notsure ~/Desktop
Then read them and make maps out of them.
'''
import numpy as np
import matplotlib.pyplot as plt

projectRoot = '/Users/aqing/Documents/1004/line-modeling_Circinus' # feifei
resultPath = f'{projectRoot}/products/fittingResult_notsure'
...
phy_info = [ # Order matter!
    ...
    ('Column Density (Nco)',     r'log$N_{\rm CO}$ (cm$^{-2}$)',  'inferno'),
