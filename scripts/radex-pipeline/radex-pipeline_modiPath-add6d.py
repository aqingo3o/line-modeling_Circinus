'''# radex-pipeline_modiPath-add6d.py
radex-pipeline_modiPath.py 加上 flux_model_6d.py(Eltha)
這邊的量個湯底: radex_pipeline.py(Eltha) & flux_model_6d.py(Eltha) 用的是 bayes 那版的, 
靠北我剛直接一個大跑錯

這邊主要的大改是修改檔案存放的路徑，需要先準備好的資料夾如同 #Path 下方註解。
可以使用 ../scripts/make-folders.py 一鍵建立所需要的資料夾
'''
"""出現的改動是:
- 展開迴圈的縮排
- flux, ratio 的檔名
...
line-modeling_Circinus/data/radex_io/input_5d-coarse2_co/
line-modeling_Circinus/data/radex_io/input_5d-coarse2_13co/
line-modeling_Circinus/data/radex_io/input_5d-coarse2_c18o/
line-modeling_Circinus/data/radex_io/output_5d-coarse2_co/
line-modeling_Circinus/data/radex_io/output_5d-coarse2_13co/
line-modeling_Circinus/data/radex_io/output_5d-coarse2_c18o/
